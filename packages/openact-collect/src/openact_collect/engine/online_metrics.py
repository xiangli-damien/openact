...
class OnlineMetricsProcessor(LogitsProcessor):
    """Logits processor that computes online generation metrics (entropy,
    perplexity, max probability) during autoregressive decoding.

    All information-theoretic quantities are in **nats** (natural logarithm),
    consistent with standard NLP convention.
    """
    ...
    def __call__(
        ...
        if self.greedy:
            ...
            # Log-probability in nats — consistent with entropy above
